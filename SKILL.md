...
| "install ComfyUI" | comfy-cli | `bash ~/.agent/skills/creative/comfyui/scripts/comfyui_setup.sh` |
...
| "is everything ready?" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/health_check.py` (optionally with `--workflow X --smoke-test`) |
| "what can I change in this workflow?" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/extract_schema.py W.json` |
| "check if W's deps are met" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/check_deps.py W.json` |
| "fix missing deps" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/auto_fix_deps.py W.json` |
| "generate an image" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/run_workflow.py --workflow W --args '{...}'` |
| "use this image" (img2img) | script | `python3 ~/.agent/skills/creative/comfyui/scripts/run_workflow.py --input-image image=./x.png ...` |
| "8 variations with random seeds" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/run_batch.py --count 8 --randomize-seed ...` |
| "show me live progress" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/ws_monitor.py --prompt-id <id>` |
| "fetch the error from job X" | script | `python3 ~/.agent/skills/creative/comfyui/scripts/fetch_logs.py <prompt_id>` |
| **Direct REST** | | |
...
```bash
python3 ~/.agent/skills/creative/comfyui/scripts/hardware_check.py --json
# Optional: also probe `torch` for actual CUDA/MPS:
python3 ~/.agent/skills/creative/comfyui/scripts/hardware_check.py --json --check-pytorch
```
...
```bash
bash ~/.agent/skills/creative/comfyui/scripts/comfyui_setup.sh
# Or with overrides:
bash ~/.agent/skills/creative/comfyui/scripts/comfyui_setup.sh --m-series --port=8190 --workspace=/data/comfy
```
...
4. Run workflows:
   ```bash
   python3 ~/.agent/skills/creative/comfyui/scripts/run_workflow.py \
...
```bash
python3 ~/.agent/skills/creative/comfyui/scripts/health_check.py
# → comfy_cli on PATH? server reachable? checkpoints? smoke test?

python3 ~/.agent/skills/creative/comfyui/scripts/check_deps.py my_workflow.json
...
python3 ~/.agent/skills/creative/comfyui/scripts/fetch_logs.py --tail-queue --host https://cloud.comfy.org
```
...
Use `python3 ~/.agent/skills/creative/comfyui/scripts/health_check.py` to run the whole list at once. Manual:
